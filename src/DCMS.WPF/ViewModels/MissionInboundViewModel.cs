...
public class MissionInboundViewModel : ViewModelBase
{
    ...
    public MissionInboundViewModel(IDbContextFactory<DCMSDbContext> contextFactory, NotificationService notificationService, CurrentUserService currentUserService, NumberingService numberingService, CodeLookupService codeLookupService, IServiceProvider serviceProvider)
    {
    ...
    private async void ExecuteSave(object? parameter)
    {
        ...
        try
        {
            ...
            var inbound = new Inbound
            {
                ...
                Category = InboundCategory.Mission,
            ...
            // Add notification
            await _notificationService.AddNotification($"تم إضافة مهمة واردة جديدة: {inbound.Subject}", inbound.Id.ToString(), Domain.Enums.NotificationType.Success);
